...
resource "aws_iam_policy" "lambda_policy" {
  ...
  description = "IAM policy for joke Lambda to access DynamoDB, SES, and logs"
...
variable "email_to" {
  description = "The recipient of the daily joke email"
}

variable "email_from" {
  description = "The SES verified sender email address"
}